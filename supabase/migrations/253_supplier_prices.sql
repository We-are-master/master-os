...
-- (markup 1.40, rascunho do dia 1). O supplier-RPA renova por TTL (~30d) e
...
insert into supplier_prices (family, variant, query, unit_cost, markup, list_price, spec, sample_product) values
  ('door_hinge', 'Butt hinge 75mm satin (pair)', 'butt hinge 75mm satin stainless pair', 4.49, 1.40, 6.99, '{"size_mm": 75, "fire_rated": false}'::jsonb, 'Smith & Locke  Polished Chrome Grade 7 Fire Rated Ball Bearing Door Hinges 76mm x 51mm 2 P'),
  ('door_hinge', 'Butt hinge 100mm satin (pair)', 'butt hinge 100mm satin stainless', 7.29, 1.40, 10.99, '{"size_mm": 100, "fire_rated": false}'::jsonb, 'Smith & Locke  Satin Stainless Steel Grade 11 Fire Rated Ball Bearing Hinges 102mm x 76mm '),
  ('door_hinge', 'Fire door hinge grade 13 CE 100mm (pack of 3)', 'fire door hinges grade 13 100mm pack 3', 15.99, 1.40, 22.99, '{"size_mm": 100, "fire_rated": true, "pack": 3}'::jsonb, 'Union PowerLoad Zinc-Plated Left-Handed Grade 13 Fire Rated Lift-Off Hinges 100mm x 88mm 3'),
  ('door_latch', 'Tubular mortice latch 64mm', 'tubular mortice latch 64mm', 3.19, 1.40, 4.99, '{"size_mm": 64, "fire_rated": false}'::jsonb, 'Smith & Locke Chrome Tubular Mortice Latch 64mm Case - 45mm Backset (339PX)'),
  ('door_latch', 'Tubular mortice latch 76mm', 'tubular mortice latch 76mm', 3.99, 1.40, 5.99, '{"size_mm": 76, "fire_rated": false}'::jsonb, 'Smith & Locke Chrome Tubular Mortice Latch 76mm Case - 57mm Backset (322PY)'),
  ('door_latch', 'Fire-rated tubular latch 76mm (FD30/60)', 'fire rated tubular mortice latch 76mm', 3.19, 1.40, 4.99, '{"size_mm": 76, "fire_rated": true}'::jsonb, 'Smith & Locke Chrome Tubular Mortice Latch 76mm Case - 57mm Backset (322PY)'),
  ('door_handle', 'Lever handle on rose satin (pair)', 'lever door handle on rose satin pair', 12.69, 1.40, 17.99, '{"style": "rose", "fire_rated": false}'::jsonb, 'Smith & Locke Bourne Fire Rated Lever on Rose Door Handles Pair Satin Chrome (101HY)'),
  ('door_handle', 'Lever handle on backplate with lock', 'lever lock door handle backplate', 12.99, 1.40, 18.99, '{"style": "backplate-lock"}'::jsonb, 'Smith & Locke Contract Fire Rated Lever Lock Door Handle Pair Satin Anodised Aluminium (20'),
  ('door_handle', 'Fire-rated lever handle (pair)', 'fire rated door handle lever', 12.99, 1.40, 18.99, '{"fire_rated": true}'::jsonb, 'Smith & Locke Corfe Fire Rated Latch Lever Door Handles Pair Polished Chrome (588HY)'),
  ('internal_door', 'White primed 686mm (27")', 'internal door white primed 686mm', 117.99, 1.40, 165.99, '{"width_mm": 686, "fire_rated": false}'::jsonb, 'Green & Taylor  Primed White Wooden Shaker Internal Door 1981mm x 686mm (499CT)'),
  ('internal_door', 'White primed 762mm (30") — padrão', 'internal door white primed 762mm', 127.99, 1.40, 179.99, '{"width_mm": 762, "fire_rated": false}'::jsonb, '4-Clear Light Primed White Wooden Shaker Internal Door 1981mm x 762mm (482FA)'),
  ('internal_door', 'White primed 838mm (33")', 'internal door white primed 838mm', 147.49, 1.40, 206.99, '{"width_mm": 838, "fire_rated": false}'::jsonb, '4-Clear Light Primed White Wooden Shaker Internal Door 1981mm x 838mm (385FA)'),
  ('internal_door', 'Fire door FD30 762mm', 'fire door fd30 762mm', 179.49, 1.40, 251.99, '{"width_mm": 762, "fire_rated": true}'::jsonb, 'Green & Taylor  Satin Painted White Wooden Cottage Internal Fire FD30 Door 1981mm x 762mm '),
  ('internal_door', 'Oak veneer 762mm', 'internal door oak 762mm', 169.49, 1.40, 237.99, '{"width_mm": 762, "finish": "oak"}'::jsonb, 'Green & Taylor  1-Clear Light Satin Lacquered Oak Wooden Traditional Internal Fire Doors w'),
  ('tv_bracket', 'Fixed até 32"', 'tv bracket fixed small', 38.79, 1.40, 54.99, '{"tv_max_in": 32, "type": "fixed"}'::jsonb, 'Sanus  Low-Profile TV Wall Bracket Fixed 47-90" (2390J)'),
  ('tv_bracket', 'Tilt 32–55"', 'tv wall bracket tilt 55 inch', 48.99, 1.40, 68.99, '{"tv_max_in": 55, "type": "tilt"}'::jsonb, 'Sanus QMT35-B2 Universal TV Wall Bracket Tilt 32-55" (161KR)'),
  ('tv_bracket', 'Full-motion 32–55"', 'tv wall bracket full motion 55 inch', 39.99, 1.40, 55.99, '{"tv_max_in": 55, "type": "full-motion"}'::jsonb, 'Ross RTMTA200 TV Bracket Full Motion 23-50" (711YN)'),
  ('tv_bracket', 'Fixed/tilt 55–85"', 'tv wall bracket 85 inch', 49.99, 1.40, 69.99, '{"tv_max_in": 85, "type": "large"}'::jsonb, 'Ross RTMF600 Flat-to-Wall TV Bracket Fixed 50-85" (510YN)'),
  ('sealant', 'Silicone branco (standard)', 'white silicone sealant 310ml', 8.99, 1.40, 12.99, '{"colour": "white"}'::jsonb, 'No Nonsense 820 Sanitary Silicone White 310ml (47187)'),
  ('sealant', 'Silicone transparente', 'clear silicone sealant 310ml', 7.99, 1.40, 11.99, '{"colour": "clear"}'::jsonb, 'Dow 781 Acetoxy Silicone Sealant Clear 310ml (32576)'),
  ('sealant', 'Sanitário HA6 (banheiro)', 'sanitary silicone sealant bathroom', 10.99, 1.40, 15.99, '{"grade": "sanitary"}'::jsonb, 'Unibond  
Kitchen & Bathroom Anti-Mould Sealant White 280ml (219CW)'),
  ('filler', 'Filler pronto (interior)', 'polyfilla ready mixed filler', 12.99, 1.40, 18.99, '{"type": "ready-mixed"}'::jsonb, 'Polycell  Trade Polyfilla All-Purpose Ready Mix Filler White 2kg (29114)'),
  ('filler', 'Wood filler 2 partes', 'two part wood filler high performance', 14.99, 1.40, 20.99, '{"type": "2-part-wood"}'::jsonb, 'Ronseal High Performance Wood Filler White 550g (45077)'),
  ('paint', 'Emulsão branca matt 5L (trade)', 'trade white matt emulsion 5l', 34.39, 1.40, 48.99, '{"finish": "matt", "litres": 5}'::jsonb, 'Dulux Trade Supermatt 5Ltr White Matt Emulsion  Paint (48384)'),
  ('paint', 'Kitchen & bathroom 2.5L', 'kitchen bathroom paint 2.5l', 17.99, 1.40, 25.99, '{"finish": "k&b", "litres": 2.5}'::jsonb, 'Fortress  2.5Ltr Brilliant White Soft Sheen Emulsion Kitchen & Bathroom Paint (637JM)'),
  ('paint', 'Gloss branco 2.5L (madeira)', 'white gloss paint 2.5l wood', 29.24, 1.40, 40.99, '{"finish": "gloss", "litres": 2.5}'::jsonb, 'Dulux Trade 2.5Ltr Pure Brilliant White High Gloss Solvent-Based Trim Paint (83378)'),
  ('blind', 'Veneziana 60cm', 'venetian blind 60cm', 8.99, 1.40, 12.99, '{"width_cm": 60}'::jsonb, 'Renaissance Venetian  Blind Grey 60cm x 150cm Drop (939CK)'),
  ('blind', 'Veneziana 90cm', 'venetian blind 90cm', 12.99, 1.40, 18.99, '{"width_cm": 90}'::jsonb, 'Renaissance Venetian  Blind White 90cm x 150cm Drop (270CK)'),
  ('blind', 'Veneziana 120cm', 'venetian blind 120cm', 16.99, 1.40, 23.99, '{"width_cm": 120}'::jsonb, 'Renaissance Venetian  Blind White 120cm x 150cm Drop (408CK)'),
  ('curtain_pole', 'Extensível 120–210cm', 'extendable curtain pole 210cm', 26.99, 1.40, 37.99, '{"max_cm": 210}'::jsonb, 'Renaissance Antique Brass Curtain Pole 28/25mm x 120-210cm (372CK)'),
  ('curtain_pole', 'Extensível 170–300cm', 'extendable curtain pole 300cm', 38.99, 1.40, 54.99, '{"max_cm": 300}'::jsonb, 'Rothley Brushed Stainless Steel Extendable Curtain Pole w/ Stud Finials 28mm x 165-300cm ('),
  ('shelf_bracket', '150mm (par)', 'shelf bracket 150mm', 10.59, 1.40, 14.99, '{"size_mm": 150}'::jsonb, 'Essentials London Shelf Brackets Grey 200mm x 150mm 20 Pack (416VJ)'),
