#!/usr/bin/env node
/**
 * Aplica a migração 290: studio 10% abaixo do 1 quarto nas três limpezas e
 * o repasse novo do deep clean (£110 studio, £120 1 quarto, +£20 por quarto).
 *
 *   node supabase/scripts/apply-290-catalogo-studio-e-repasse-deep.mjs            # mostra as faixas de hoje
 *   node supabase/scripts/apply-290-catalogo-studio-e-repasse-deep.mjs --aplicar  # aplica e mostra o depois
 */
...
await q(readFileSync(join(RAIZ, "supabase/migrations/290_catalogo_studio_e_repasse_deep.sql"), "utf8"));
console.log("\nDEPOIS");
await faixas();
