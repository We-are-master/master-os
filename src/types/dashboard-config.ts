...
/**
 * Widget library labels use the exact titles that render on the dashboard
 * (Monthly Overview, Cash Flow, Top 5 — partners, etc.) so the Widgets editor
 * and the page stay aligned. Descriptions list every block a widget contains
 * when it bundles more than one card (e.g. Monthly Overview).
 */
export const WIDGET_CATALOG: WidgetMeta[] = [
  { type: "stats_grid",          label: "Monthly Overview",        description: "Monthly Overview · Today snapshot · Tier vs Revenue · Invoice due — cash forecast · Top 5 partners & weeks · Cash flow", icon: "BarChart2", defaultSize: "full" },
  { type: "revenue_chart",       label: "Revenue Overview",        description: "Collected vs invoiced revenue per month",                                   icon: "TrendingUp",    defaultSize: "full" },
  { type: "quote_funnel",        label: "Request → Job Funnel",    description: "End-to-end conversion: request → quote → job",                              icon: "Filter",        defaultSize: "one_third" },
  ...
  { type: "partners_by_trade",   label: "Partners by Trade",       description: "Active vs inactive partners with a donut breakdown by type of work",        icon: "Users",         defaultSize: "one_third" },
  { type: "margin_chart",        label: "Margin (%)",              description: "Margin percentage trend over time",                                         icon: "Percent",       defaultSize: "one_third" },
  { type: "partner_performance", label: "Top Partners",            description: "Partner ranking by gross margin and job count",                             icon: "Award",         defaultSize: "half" },
  { type: "partner_payout_top5", label: "Partner payout · Top 5",  description: "Largest partner costs / payouts in the period (place beside Pipeline)",     icon: "DollarSign",    defaultSize: "one_third" },
  { type: "partner_margin_top5", label: "Company margin · Top 5",  description: "Partners where you keep the most gross margin (place beside Pipeline)",     icon: "PieChart",      defaultSize: "one_third" },
  ...
  { type: "priority_tasks",      label: "Priority Actions",        description: "Jobs and quotes requiring attention",                                       icon: "AlertTriangle", defaultSize: "one_third" },
  { type: "activity_feed",       label: "Recent Activity",         description: "Recent events across the system",                                           icon: "Activity",      defaultSize: "one_third" },
