...
export const WIDGET_CATALOG: WidgetMeta[] = [
  ...
  { type: "partner_performance", label: "Top Partners — margin",   description: "Partner ranking by gross margin and job count",                             icon: "Award",         defaultSize: "half" },
  { type: "partner_payout_top5", label: "Top 5 — partner payouts", description: "Largest partner costs / payouts in the period (place beside Pipeline)",     icon: "DollarSign",    defaultSize: "one_third" },
  { type: "partner_margin_top5", label: "Top 5 — company margin",  description: "Partners where you keep the most gross margin (place beside Pipeline)",     icon: "PieChart",      defaultSize: "one_third" },
  { type: "finance_flow",        label: "Cash Flow",               description: "Collected vs partner payouts vs net",                                       icon: "DollarSign",    defaultSize: "half" },
  { type: "financial_snapshot",  label: "Financial Position",      description: "Full financial position summary",                                           icon: "Receipt",       defaultSize: "full" },
  { type: "pipeline_summary",    label: "Sales Pipeline",          description: "Requests → quotes sent → jobs booked → completed (values)",                 icon: "Layers",        defaultSize: "one_third" },
