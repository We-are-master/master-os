...
export function UkCoveragePicker({
  ...
  return (
    <div className="space-y-2">
      <label className="text-xs font-medium text-text-secondary">Coverage (UK)</label>
      <button
        type="button"
        id={`${idPrefix}-whole`}
        onClick={() => {
      ...
      <p className="text-[10px] text-text-tertiary">
        {whole
          ? "Nationwide — clear “Whole UK” to pick specific regions."
          : "Select all regions this partner covers. Default is London."}
      </p>
