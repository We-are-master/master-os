      ...
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        <section className="rounded-xl border bg-card p-5 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
            <div>
              <span className="text-muted-foreground block text-xs">Fixed payment</span>
            ...
            {person.commission_enabled ? (
              <div className="sm:col-span-2">
                ...
                <p className="font-medium">
                  {formatCurrency(person.amount)} base + {person.commission_rate_percent}% on {basisLabel}
                </p>
              </div>
            ) : (
              <div className="sm:col-span-2">
                <span className="text-muted-foreground block text-xs">Commission</span>
                <p className="font-medium">None — fixed payment only</p>
              </div>
            )}
          </div>
        </section>
        ...
        <section className="rounded-xl border bg-card p-5 space-y-3">
          ...
          <div className="grid gap-3">
            ...
            <div>
              ...
              <Input value={profile.ni_number} onChange={(e) => setProfile((p) => ({ ...p, ni_number: e.target.value }))} />
            </div>
            <div>
              <label className="block text-xs font-medium text-text-secondary mb-1">Tax code</label>
              <Input value={profile.tax_code} onChange={(e) => setProfile((p) => ({ ...p, tax_code: e.target.value }))} />
            </div>
            <div>
              <label className="block text-xs font-medium text-text-secondary mb-1">UTR</label>
              <Input value={profile.utr} onChange={(e) => setProfile((p) => ({ ...p, utr: e.target.value }))} />
            </div>
          </div>
        </section>
